...
router.get('/item_management/product/product_available', jwtAuth(), Product.productAvailable);
router.get('/item_management/product/product_almost_out', jwtAuth(), Product.productAlmostOut);
router.get('/item_management/product/product_expired', jwtAuth(), Product.productExpired);
router.get('/item_management/product/product_sold_out', jwtAuth(), Product.productSoldOut);
